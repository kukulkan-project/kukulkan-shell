...
package org.springframework.cloud.stream.app.costos.processor;
...
/**
 * Integration Tests for the costos Processor.
 *
 * @author Eric Bottard
...
@DirtiesContext
@SpringBootTest
public abstract class CostosProcessorIntegrationTests {
	 ...
	 */
	public static class UsingNothingIntegrationTests extends CostosProcessorIntegrationTests {
	...
	public static class UsingExpressionIntegrationTests extends CostosProcessorIntegrationTests {
	...
	public static class PayloadTypeDifferentFromOutputContentTypeTests extends CostosProcessorIntegrationTests {
	...
	@SpringBootTest("transformer.expression=payload.toUpperCase()")
	public static class OctetPayloadForTextJsonTupleContentTypesTests extends CostosProcessorIntegrationTests {
	...
	public static class CostosProcessorApplication {
